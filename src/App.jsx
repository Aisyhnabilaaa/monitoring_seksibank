  ...
  return (
    <Routes>
      ...
      <Route path="/" element={<UserLayout />}>
        ...
        {/* Layanan Routes */}
        <Route path="layanan/Penyelesaian Retur Atas SP2D" element={<LayananA />} />
        <Route path="layanan/Penerbitan Nota Konfirmasi Atas Penerimaan Negara" element={<LayananB />} />
        <Route path="layanan/Koreksi Penerimaan Negara Atas Setoran Satuan Kerja" element={<LayananC />} />
        <Route path="layanan/Permohonan VOID SP2D" element={<LayananD />} />
        <Route path="layanan/Penerbitan Surat Persetujuan / Penolakan Pembukaan Rekening Satker" element={<LayananE />} />
        <Route path="layanan/Laporan Pembukaan / Penutupan Rekening" element={<LayananF />} />
        <Route path="layanan/Pengembalian PFK" element={<LayananG />} />
        <Route path="layanan/Penerbitan Bukti Penerimaan Negara" element={<LayananH />} />

        {/* Dokumen Routes */}
        <Route path="dokumen/Penyelesaian Retur Atas SP2D" element={<DokumenA />} />
        <Route path="dokumen/Penerbitan Nota Konfirmasi Atas Penerimaan Negara" element={<DokumenB />} />
        <Route path="dokumen/Koreksi Penerimaan Negara Atas Setoran Satuan Kerja" element={<DokumenC />} />
        <Route path="dokumen/Permohonan VOID SP2D" element={<DokumenD />} />
        <Route path="dokumen/Penerbitan Surat Persetujuan / Penolakan Pembukaan Rekening Satker" element={<DokumenE />} />
        <Route path="dokumen/Laporan Pembukaan / Penutupan Rekening" element={<DokumenF />} />
        <Route path="dokumen/Pengembalian PFK" element={<DokumenG />} />
        <Route path="dokumen/Penerbitan Bukti Penerimaan Negara" element={<DokumenH />} />
        <Route path="dokumen/Pengembalian PNBP" element={<DokumenI />} />

        {/* Monitoring Routes */}
        <Route path="monitoring/Penyelesaian Retur Atas SP2D" element={<MonitoringA />} />
        <Route path="monitoring/Penerbitan Nota Konfirmasi Atas Penerimaan Negara" element={<MonitoringB />} />
        <Route path="monitoring/Koreksi Penerimaan Negara Atas Setoran Satuan Kerja" element={<MonitoringC />} />
        <Route path="monitoring/Permohonan VOID SP2D" element={<MonitoringD />} />
        <Route path="monitoring/Penerbitan Surat Persetujuan / Penolakan Pembukaan Rekening Satker" element={<MonitoringE />} />
        <Route path="monitoring/Laporan Pembukaan / Penutupan Rekening" element={<MonitoringF />} />
        <Route path="monitoring/Pengembalian PFK" element={<MonitoringG />} />
        <Route path="monitoring/Penerbitan Bukti Penerimaan Negara" element={<MonitoringH />} />
