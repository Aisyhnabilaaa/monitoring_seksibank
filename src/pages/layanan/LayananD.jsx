      ...
      <section className="layanan-content py-5">
        ...
        <Row className="d-flex align-items-start">
            ...
            <Col xs={12} md={6} className="text-start">
              ...
              Void SP2D adalah pembatalan atas Surat Perintah Pencairan Dana (SP2D) yang sudah diterbitkan oleh Kantor Pelayanan Perbendaharaan Negara (KPPN).
              </p>
            ...
            <Col xs={12} md={6} className="text-start">
              ...
              <ul className="list-unstyled">
                    <li className="list-item-bordered d-flex align-items-center gap-2">
                        <span className="text-purple">●</span>Satker mengajukan surat permohonan Void SP2D pada KPPN sesuai format yang disediakan.
                    </li>
                    <li className="list-item-bordered d-flex align-items-center gap-2">
                        <span className="text-purple">●</span>KPPN melakukan pemeriksaan atas permohonan Void SP2D yang diajukan oleh satker.
                    </li>
                    <li className="list-item-bordered d-flex align-items-center gap-2">
                        <span className="text-purple">●</span>Apabila telah sesuai dan transaksi memenuhi syarat untuk dilakukan Void SP2D maka KPPN selanjutnya membuat Nota Dinas ke Direktorat Sistem Informasi Dan Teknologi Perbendaharaan atas Permohonan Void SP2D tersebut.
                    </li>
                    <li className="list-item-bordered d-flex align-items-center gap-2">
                        <span className="text-purple">●</span>Apabila telah dilakukan proses Void oleh Direktorat Sistem Informasi Dan Teknologi Perbendaharaan, KPPN memlakukan pembatalan invoice dan memberikan pemberitahuan ke satker atas Void yang telah dilakukan.
                    </li>
             </ul>
            </Col>
          </Row>
          ...
          <Row className="align-items-center">
            ...
            <Col xs={12} className="text-center mb-4">
              <h1 className="dokjudul-D text-4xl fw-bold">
                Dokumen Kelengkapan <br />Permohonan VOID SP2D
              </h1>
            </Col>
            {/*Daftar Dokumen */}
              ...
              <div className="dokumen-list d-flex flex-column flex-lg-row align-items-start gap-5">
                <div className="dokumen-content flex-grow-1">
                  {[
                    ...
                    { number: "3", desc: "Dokumen pendukung lainnya (untuk mendukung alasan void dilakukan)" },
