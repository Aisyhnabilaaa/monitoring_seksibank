          ...
          <Container>
            <Row className="d-flex align-items-start">
              ...
              <Col xs={12} md={6} className="text-start">
                ...
                <ul className="list-unstyled">
                  <li className="list-item-bordered d-flex align-items-center gap-2">
                    <span className="text-purple">●</span>Satker Kementerian Negara/Lembaga.
                  </li>
                  <li className="list-item-bordered d-flex align-items-center gap-2">
                  ...
                  <li className="list-item-bordered d-flex align-items-center gap-2">
                    <span className="text-purple">●</span>Pihak Lain selaku penyetor dana PFK.
                  </li>
                </ul>
              </Col>
              ...
              <Col xs={5} md={6} className="text-start mt-5">
                <p className="text-black fs-4 "> <strong>Ketentuan lanjutan atas pengajuan permintaan pengembalian yang telah diproses oleh KPPN :</strong>
                </p>
                <ul className="list-unstyled">
                  <li className="list-item-bordered d-flex align-items-center gap-2">
                    <span className="text-purple">●</span>Seluruh permintaan pengembalian yang telah diterima oleh KPPN akan diteruskan ke Direktorat Sistem Perbendaharaan (DSP) karena wewenang pengembalian ada di DSP c.q. Kepala Subdit Pembayaran Program Jaminan Sosial, Perhitungan Fihak Ketiga, dan Kebijakan Tuntutan Ganti Rugi.
                  </li>
                  <li className="list-item-bordered d-flex align-items-center gap-2">
                    <span className="text-purple">●</span>Permintaan pengembalian PFK tidak terikat tahun anggaran.
                  </li>
                  <li className="list-item-bordered d-flex align-items-center gap-2">
                    <span className="text-purple">●</span>Permintaan pengembalian PFK mengurangi dana PFK periode tahun berjalan.
                  </li>
                </ul>
              </Col>
            </Row>
        ...
        Dokumen Persyaratan:
          ...
          <Container fluid>
            ...
            <div style={{
              ...
              <Row className="d-flex flex-nowrap" style={{ display: "flex", flexWrap: "nowrap" }}>
                
                {/* Dokumen Kelengkapan 1 */}
                <Col className="flex-shrink-0" style={{ minWidth: "150px", padding: "10px" }}>
                ...
                <Col className="flex-shrink-0" style={{ minWidth: "150px", padding: "10px" }}>
                  <section className="p-5 border rounded shadow-sm bg-light">
                    <h2 className="fw-bold text-justify mb-4">
                      Pemerintah Daerah dan/atau Pihak Lain selaku <br /> penyetor dana PFK
                       mengajukan permintaan <br /> dengan kelengkapan:
                    </h2>
                    <div className="d-flex flex-column gap-3">
                      {[
                        "Surat Permintaan Pembayaran Pengembalian PFK sesuai format Lampiran A pada SE-108/PB/2018",
                ...
                <Col className="flex-shrink-0" style={{ minWidth: "150px", padding: "10px" }}>
                  <section className="p-5 border rounded shadow-sm bg-light">
                    <h2 className="fw-bold text-justify mb-4">
                      Bank/Pos Persepsi mengajukan permintaan <br /> dengan kelengkapan:
                    </h2>
                    <div className="d-flex flex-column gap-3">
                      {[
                        "Surat Permintaan Pembayaran Pengembalian PFK sesuai format Lampiran A pada SE-108/PB/2018",
