        ...
        <Row className="d-flex align-items-start">
            ...
            <Col xs={12} md={6} className="text-start">
              ...
              <h2 className="fw-bold text-dark">
                Layanan<br />
                <span className="text-definisi-B">Penerbitan Nota Konfirmasi Atas Penerimaan Negara</span> 
              </h2>
              <p className="text-black">
              Nota Konfirmasi Penerimaan Negara (NKPN) adalah dokumen yang diterbitkan untuk memastikan penerimaan negara 
              telah masuk ke kas negara, setoran penerimaan negara yang disetor pada Bank Persepsi atau Pos Persepsi, dapat 
              dikonfirmasi paling cepat pada H + 1 setelah penyetoran penerimaan negara.
              </p>
              ...
              <div className="dokumen-list d-flex flex-column flex-lg-row align-items-start gap-5">
                <div className="dokumen-content flex-grow-1">
                  {[
                    ...
                    { number: "4", desc: "ADK Konfirmasi yang disampaikan oleh Satuan Kerja" }
                  ].map((item, index) => (
