  ...
  return (
    <div className='Layanan-D'>
          ...
          <Row className='d-flex justify-content-center text-center'>
            ...
            <Col xs={12} md={8} lg={6}>
              ...
              <p className='text-black text-justify'>
                KPA/ Kepala Satuan Kerja/ Pimpinan BLU harus menyampaikan
                laporan pembukaan Rekening kepada Kuasa BUN di Daerah paling
                lambat:
              </p>
              <ul className='list-unstyled text-justify'>
                <li className='list-item-bordered d-flex align-items-center gap-2'>
                  <span className='text-purple '>●</span>20 (dua puluh) hari
                  kerja sejak terbitnya surat persetujuan pembukaan Rekening;
                  dan
                </li>
                <li className='list-item-bordered d-flex align-items-center gap-2'>
                  <span className='text-purple'>●</span>10 (sepuluh) hari kerj a
                  sej ak pembukaan rekening pengelolaan kas BLU dalam bentuk
                  deposito.
                </li>
              </ul>
            </Col>
      ...
      <div className='wrapper'>
        <h1 className='dokjudul-B text-3xl fw-bold mb-5 text-center'>
          Dokumen Persyaratan
        </h1>
