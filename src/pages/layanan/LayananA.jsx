      ...
      <section className="layanan-content py-5">
        ...
        <Row className="d-flex align-items-start">
            ...
            <Col xs={12} md={6} className="text-start">
              ...
              Retur SP2D adalah penolakan atau pengembalian atas pemindahbukuan dana APBN dari bank penerima ke 
              bank pengirim. Retur SP2D dapat terjadi karena kesalahan nama atau nomor rekening, atau rekening 
              tidak aktif.
              </p>
            ...
            <Col xs={12} md={6} className="text-start">
              <h1 className="fw-bold text-dark">
                Sistem, mekanisme dan prosedur </h1>
                <h2 className="layananretur fw-bold">
                Layanan Retur SP2D
                </h2>
              <ul className="list-unstyled">
                    <li className="list-item-bordered d-flex align-items-center gap-2">
                        <span className="text-purple">●</span>KPPN melakukan monitoring ada/tidaknya retur atas SP2D, monitoring dilakukan setiap hari secara berkala melalui SPAN EXT.
                    </li>
                    <li className="list-item-bordered d-flex align-items-center gap-2">
                        <span className="text-purple">●</span>Apabila terdapat retur satker, KPPN membuat surat pemberitahuan retur SP2D ke satker.
                    </li>
                    <li className="list-item-bordered d-flex align-items-center gap-2">
                        <span className="text-purple">●</span>Satker melakukan pengecekan atas retur yang ada, mendaftarkan/melakukan perubahan supplier (apabila diperlukan), dan membuat dokumen kelengkapan retur.
                    </li>
                    <li className="list-item-bordered d-flex align-items-center gap-2">
                        <span className="text-purple">●</span>Satker mengirimkan dokumen kelengkapan retur ke KPPN melalui sarana yang tersedia.
                    </li>
                    <li className="list-item-bordered d-flex align-items-center gap-2">
            ...
            <Col xs={12} lg={10} className="mx-auto">
              <div className="dokumen-list d-flex flex-column flex-lg-row align-items-start gap-5">
                <div className="dokumen-content flex-grow-1">
                  {[
                    { number: "1", desc: "Surat Ralat/Perbaikan Rekening (SRPR)" },
                    { number: "2", desc: "Daftar Ralat/Perbaikan Data Rekening Penerima Pembayaran" },
                    { number: "3", desc: "Surat Pernyataan Tanggungjawab Mutlak (SPTJM) bermaterai" },
                    { number: "4", desc: "Surat perubahan data supplier (dalam hal terdapat perubahan Nama pemilik rekening)" },
                    { number: "5", desc: "Bukti upload adk BCSR (dalam hal terdapat perubahan nomor rekening penerima retur)" },
                    { number: "6", desc: "Surat keterangan rekening aktif dari bank (dalam hal retur disebabkan karena rekening tidak aktif dan tidak melakukan perubahan rekening)" }
                  ].map((item, index) => (
        ...
        <Container>
            ...
            {[
            [
                { icon: <RiErrorWarningFill />, desc: "SPTJM harap diberi materai." },
                {
            ...
            <Row key={rowIndex} className="justify-content-center mb-4">
                {row.map((item, index) => (
                <Col key={index} xs={12} md={6} className="d-flex align-items-center gap-3">
                    <div className="text-primary d-flex align-items-center justify-content-center" style={{ fontSize: "2rem", minWidth: "50px" }}>
                    {item.icon}
                    </div>
