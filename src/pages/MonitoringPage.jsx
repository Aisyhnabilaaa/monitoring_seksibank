...
const MonitoringPage = () => {
  ...
  return (
    <div>
      <NavbarComponent />\{/* Section Daftar Layanan */}
            ...
            <Col xs={12} md={25}>
              <div className='d-flex flex-wrap justify-content-center gap-3'>
                <button
                  ...
                  onClick={() =>
                    navigate('/monitoring/Penyelesaian Retur Atas SP2D')
                  }
                >
                ...
                <button
                  ...
                  onClick={() =>
                    navigate(
                      '/monitoring/Penerbitan Nota Konfirmasi Atas Penerimaan Negara'
                    )
                  }
                >
                ...
                <button
                  ...
                  onClick={() =>
                    navigate(
                      '/monitoring/Koreksi Penerimaan Negara Atas Setoran Satuan Kerja'
                    )
                  }
                >
                ...
                <button
                  className='layanan-btn'
                  onClick={() => navigate('/monitoring/Permohonan VOID SP2D')}
                >
            ...
            <Col xs={12} md={25}>
              <div className='d-flex flex-wrap justify-content-center gap-3'>
                <button
                  ...
                  onClick={() =>
                    navigate(
                      '/monitoring/Penerbitan Surat Persetujuan / Penolakan Pembukaan Rekening Satker'
                    )
                  }
                >
                ...
                <button
                  ...
                  onClick={() =>
                    navigate(
                      '/monitoring/Laporan Pembukaan / Penutupan Rekening'
                    )
                  }
                >
                ...
                <button
                  className='layanan-btn'
                  onClick={() => navigate('/monitoring/Pengembalian PFK')}
                >
                  Pengembalian PFK
                </button>
                <button
                  className='layanan-btn'
                  onClick={() =>
                    navigate('/monitoring/Penerbitan Bukti Penerimaan Negara')
                  }
                >
                  Penerbitan Bukti Penerimaan Negara
                </button>
                <button
                  className='layanan-btn p-3'
                  onClick={() => navigate('/monitoring/Pengembalian PNBP')}
                >
                  Pengembalian PNBP
                </button>
              </div>
